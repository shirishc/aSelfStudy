...
.controller('AppCtrl', function($scope, $ionicModal, $timeout) {
  ...
  // Create the reserveForm modal that we will use later
  ...
  // Triggered in the reserveForm modal to close it
  $scope.closeReserve = function() {
    $scope.reserveForm.hide();
  };

  // Open the reserveForm modal
...
.controller('MenuController', ['$scope', 'menuFactory', 'favoriteFactory', 'baseURL',
            '$ionicListDelegate', function($scope, menuFactory, favoriteFactory,
